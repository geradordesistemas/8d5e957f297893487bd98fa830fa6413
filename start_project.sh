...
./run.sh bin/console security:create-admin AlanGuedes alanguedes00@live.com 8d5e957f297893487bd98fa830fa6413

# Cria usuário padrão
./run.sh bin/console security:create-user AlanGuedes alanguedes00@live.com 8d5e957f297893487bd98fa830fa6413
